<?php
  ...
  function jgetmenu($activepage) {
      ...
      //Branding
      $header .= '<div class="navbar-form" style="margin-top:0px; margin-bottom: 3.5px; padding-left:0px; padding-right:0px"><a class="navbar-left" href="/"><img src="img/icon_orange.png" style="height:50px; padding:5px" alt="Journey Checker"></a>';
      ...
      $header .= '<p class="navbar-text navbar-right" id="lastupdate"></p><p class="navbar-text navbar-right" id="lastupdateerror"></p>';
